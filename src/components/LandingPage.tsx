        ...
        {!countdown.isExpired && (
          <div className="relative z-10 mb-12 px-4">
            <div className="max-w-4xl mx-auto">
              <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 backdrop-blur-sm border-2 border-purple-500 rounded-xl p-2 md:p-3">
                <h3 className="font-pixelify font-bold text-white text-xs md:text-sm mb-2 text-center">
                  Competition Ends In:
                </h3>
                <div className="flex justify-center gap-2 md:gap-3">
                  <div className="flex flex-col items-center">
                    <div className="bg-black/50 border-2 border-purple-400 rounded-lg px-2 py-1 md:px-3 md:py-2 min-w-[50px] md:min-w-[65px]">
                      <span className="font-pixelify font-bold text-xl md:text-3xl text-white">
                        {countdown.days}
                      </span>
                    </div>
                    <span className="font-pixelify text-[10px] md:text-xs text-purple-300 mt-0.5">Days</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="bg-black/50 border-2 border-purple-400 rounded-lg px-2 py-1 md:px-3 md:py-2 min-w-[50px] md:min-w-[65px]">
                      <span className="font-pixelify font-bold text-xl md:text-3xl text-white">
                    ...
                    <span className="font-pixelify text-[10px] md:text-xs text-purple-300 mt-0.5">Hours</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="bg-black/50 border-2 border-purple-400 rounded-lg px-2 py-1 md:px-3 md:py-2 min-w-[50px] md:min-w-[65px]">
                      <span className="font-pixelify font-bold text-xl md:text-3xl text-white">
                    ...
                    <span className="font-pixelify text-[10px] md:text-xs text-purple-300 mt-0.5">Minutes</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="bg-black/50 border-2 border-purple-400 rounded-lg px-2 py-1 md:px-3 md:py-2 min-w-[50px] md:min-w-[65px]">
                      <span className="font-pixelify font-bold text-xl md:text-3xl text-white">
                    ...
                    <span className="font-pixelify text-[10px] md:text-xs text-purple-300 mt-0.5">Seconds</span>
                  </div>
                </div>
              </div>
            </div>
